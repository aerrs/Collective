...
public class PlaytimeTrackerTest
{
	...
	{
		tracker.recordElapsed(1500, "Clan", "Tester");
		assertEquals(1, tracker.pendingSeconds());

		tracker.recordElapsed(600, "Clan", "Tester");
	...
	public void subSecondSlicesEventuallyFormSeconds()
	{
		for (int i = 0; i < 10; i++)
		{
			tracker.recordElapsed(100, "Clan", "Tester");
		}
		assertEquals(1, tracker.pendingSeconds());
	}
	...
	{
		tracker.recordElapsed(5000, "Clan", "Tester");
		assertEquals(5, tracker.pendingSeconds());

		tracker.onSendResult(true, 5);
	...
	{
		tracker.recordElapsed(5000, "Clan", "Tester");
		tracker.recordElapsed(3000, "Clan", "Tester");
		tracker.onSendResult(true, 5);
